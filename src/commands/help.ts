...
function helpCommands(): string {
	return [
		...
		"  lab gather <slug>              output gather context for a topic",
		"  lab verify <slug>              check claims and output corroboration context",
		"  lab refine <slug>              output tournament protocol for a section",
		"    [--section S]                section to refine (default: Findings)",
		"  lab refine apply <slug>        write refined section back to hub",
